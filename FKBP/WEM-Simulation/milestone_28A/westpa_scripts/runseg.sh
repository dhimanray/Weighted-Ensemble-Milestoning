...
ln -sv $WEST_SIM_ROOT/namd_config/ionized.psf .
ln -sv $WEST_SIM_ROOT/namd_config/ionized.pdb .
#ln -sv $WEST_SIM_ROOT/namd_config/par_all36m_prot.prm
#ln -sv $WEST_SIM_ROOT/namd_config/par_all36_cgenff.prm
#ln -sv $WEST_SIM_ROOT/namd_config/par_all36_carb.prm
#ln -sv $WEST_SIM_ROOT/namd_config/par_all36_lipid.prm
#ln -sv $WEST_SIM_ROOT/namd_config/par_all36_na.prm
#ln -sv $WEST_SIM_ROOT/namd_config/buq.prm
#ln -sv $WEST_SIM_ROOT/namd_config/toppar_water_ions_namd.str
ln -sv $WEST_SIM_ROOT/namd_config/toppar .

#Make symbolic lik to colvars input file
ln -sv $WEST_SIM_ROOT/bstates/bound/distance.in .
...
/home/dray1/NAMD_2.13_Linux-x86_64-multicore-CUDA/namd2 +idlepoll +isomalloc_sync +p 4 md.conf > seg.log

########################## Calculate and return data ###########################

# Calculate the progress coordinate, which is the distance between protein and ligand
python $WEST_SIM_ROOT/westpa_scripts/calculatedistance.py > r.dat 
