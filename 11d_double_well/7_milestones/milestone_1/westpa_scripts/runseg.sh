...
ln -sv $WEST_PARENT_DATA_REF/trajectory.dat  ./parent.dat

############################## Run the dynamics ################################
# Propagate the segment using namd2 
#python 2d_langevin.py 
...
python $WEST_SIM_ROOT/westpa_scripts/calculate_x.py > $WEST_PCOORD_RETURN
...
# Clean up
#rm -f seg.log md.conf parent.coor parent.dcd parent.vel parent.xsc seg.pdb \
