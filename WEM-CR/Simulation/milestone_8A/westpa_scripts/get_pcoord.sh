...
#ln -s $WEST_SIM_ROOT/namd_config/A.psf structure.psf
#echo "Simlink done"
...
python $WEST_SIM_ROOT/westpa_scripts/calculatedistance_init.py > r.dat

# Pipe the relevant part of the output file (the distance) to $WEST_PCOORD_RETURN
cat r.dat | tail -n 1 > $WEST_PCOORD_RETURN
