...
cd /oasis/tscc/scratch/dray1/dhiman/WEM-Testing/FKBP/CHARMM36/WEM/constrain-release/trial_1/milestone_28A
...
cp namd_config/distance.new.in  bstates/bound/
...
rm -f west.log
$WEST_ROOT/bin/w_run --work-manager processes --n-workers 10 "$@" &> west.log
