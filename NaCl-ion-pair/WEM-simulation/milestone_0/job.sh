...
/data/users/dray1/NAMD_2.13_Linux-x86_64-multicore/namd2 +p4 equilibration.conf > equilibration.log 
...
rm -f west.log
$WEST_ROOT/bin/w_run --work-manager processes --n-workers 4 "$@" &> west.log
