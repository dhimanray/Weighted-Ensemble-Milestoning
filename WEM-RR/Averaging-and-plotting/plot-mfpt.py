...
plt.fill_between(l11[:,0], l11[:,1]-l11[:,3], l11[:,1]+l11[:,3], facecolor='xkcd:lightgreen') #,alpha=0.3)
plt.fill_between(l12[:,0], l12[:,1]-l12[:,3], l12[:,1]+l12[:,3], facecolor='xkcd:lightblue')
plt.fill_between(l13[:,0], l13[:,1]-l13[:,3], l13[:,1]+l13[:,3], facecolor='xkcd:pink') #,alpha=0.3)
plt.fill_between(l2[:,0], l2[:,1]-l2[:,3], l2[:,1]+l2[:,3], facecolor='xkcd:gray')
...
plt.tight_layout()
#plt.show()
plt.savefig('mfpt-plot-cons-release.pdf')
