...
l11 = np.loadtxt('../trial_1/dataset/committor.dat')
l12 = np.loadtxt('../trial_2/dataset/committor.dat')
l13 = np.loadtxt('../trial_3/dataset/committor.dat')
...
plt.tight_layout()
#plt.show()
plt.savefig('committor-plot-cons-release.pdf')
