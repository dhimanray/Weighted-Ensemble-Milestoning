...
cp prep/eq/A_production.coor bstates/unbound/seg.coor
cp prep/eq/A_production.colvars.traj  bstates/unbound/seg.colvars.traj
cp prep/eq/A_production.vel  bstates/unbound/seg.vel
cp prep/eq/A_production.xsc  bstates/unbound/seg.xsc

#cp prep/eq/A.psf   namd_config/nacl.psf
#cp prep/eq/A.pdb   namd_config/nacl.pdb
...
TSTATE_ARGS="--tstate bound,179.0"
