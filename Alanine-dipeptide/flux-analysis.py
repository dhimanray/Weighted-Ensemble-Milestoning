...
mile = [ -100.0, -60.0, -20.0, 20.0, 60.0, 100.0, 150.0, 180.0 ]
...
p_x = np.multiply(q_matrix[3],t)    #choose the eigenvector corresponding to eigenvalue 1 (the index of milestone where things start x = -1)
p_x = p_x/sum(p_x)
